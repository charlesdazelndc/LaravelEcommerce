...
{{Form::open(['route'=>'save_product','method'=>'post','class'=>'form-horizontal','enctype'=>'multipart/form-data'])}}
...
<div class="form-group">
  ...
  <label for="comment" class="col-md-3">Product Price</label>
   <div class="col-md-9">
  <input type="float" class="form-control"   name="product_price"/>
...
<div class="form-group">
  <label for="comment" class="col-md-3">Short Description:</label>
    <div class="col-md-9">
  <textarea class="form-control" rows="5" id="comment" name="short_description"></textarea>
...
<div class="form-group">
  <label for="comment" class="col-md-3"> Product Details:</label>
    <div class="col-md-9">
  <textarea class="form-control" rows="5" id="editor" name="long_description"></textarea>
