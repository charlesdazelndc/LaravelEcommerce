...
@section('body')
<div class="banner1" style=" background-image: url('{{asset('images/frontend_img/b1.jpg')}}')">
			<div class="container">
						...
						<div class="product-agileinfo-grids w3l">
							<div class="col-md-3 product-agileinfo-grid">
								...
								<div class="price">
									...
									<script type="text/javascript" src="{{asset('js/frontend_js/jquery-ui.js')}}"></script>
								</div>
								<div class="top-rates">
								...
								<div class="cat-img">
									<img class="img-responsive " src="{{ asset('/') }}/images/frontend_img/45.jpg" alt="">
								</div>
							</div>
							<div class="col-md-9 product-agileinfon-grid1 w3l">
								<div class="product-agileinfon-top">
									<div class="col-md-6 product-agileinfon-top-left">
										<img class="img-responsive " src="{{ asset('/') }}/images/frontend_img/img1.jpg" alt="">
									</div>
									<div class="col-md-6 product-agileinfon-top-left">
										<img class="img-responsive " src="{{ asset('/') }}/images/frontend_img/img2.jpg" alt="">
									</div>
									<div class="clearfix"></div>
								</div>
								...
								<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
									...
									<li role="presentation" class="active"><a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true"><img src="{{ asset('/') }}/images/frontend_img/menu1.png"></a></li>
									<li role="presentation"><a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile"><img src="{{ asset('/') }}/images/frontend_img/menu.png"></a></li>
									</ul>
												...
												<div class="col-md-4 product-tab-grid simpleCart_shelfItem">
													<div class="grid-arr">
														...
														<div class="women">
															...
															<p ><em class="item_price">{{ $categoryproduct->product_image}}</em></p>
