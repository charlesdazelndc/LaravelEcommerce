							...
							<div clas="single-top">
								<div class="single-left">
									<div class="flexslider">
										<ul class="slides">
											<li data-thumb="{{ asset('/') }}/images/frontend_img/si.jpg">
												<div class="thumb-image"> <img src="{{ asset($product->product_image) }}" data-imagezoom="true" class="img-responsive"> </div>
											</li>
											<li data-thumb="{{ asset('/') }}/images/frontend_img/si1.jpg">
												 <div class="thumb-image"> <img src="{{ asset($product->product_image ) }}" data-imagezoom="true" class="img-responsive"> </div>
											</li>
											<li data-thumb="{{ asset('/') }}/images/frontend_img/si2.jpg">
											   <div class="thumb-image"> <img src="{{ asset($product->product_image ) }}" data-imagezoom="true" class="img-responsive"> </div>
											</li> 
										 </ul>
									</div>
						...
						<div class="col-md-3 single-grid1">
							...
							<div class="recent-grids">
								<div class="recent-left">
									<a href="single.html"><img class="img-responsive " src="{{ asset('/') }}/images/frontend_img/r.jpg" alt=""></a>	
								</div>
							...
							<div class="recent-grids">
								<div class="recent-left">
									<a href="single.html"><img class="img-responsive " src="{{ asset('/') }}/images/frontend_img/r1.jpg" alt=""></a>	
								</div>
								<div class="recent-right">
							...
							<div class="recent-grids">
								<div class="recent-left">
									<a href="single.html"><img class="img-responsive " src="{{ asset('/') }}/images/frontend_img/r2.jpg" alt=""></a>	
								</div>
								<div class="recent-right">
									<h6 class="best2"><a href="single.html">Lorem ipsum dolor </a></h6>
									<div class="block">
							...
							<div class="recent-grids">
								<div class="recent-left">
									<a href="single.html"><img class="img-responsive " src="{{ asset('/') }}/images/frontend_img/r3.jpg" alt=""></a>	
								</div>
								<div class="recent-right">
								...
								<div class="col-md-4 product-grid">
									<div id="owl-demo" class="owl-carousel">
										...
										<div class="item">
											<div class="recent-grids">
												<div class="recent-left">
													<a href="single.html"><img class="img-responsive " src="{{ asset('/') }}/images/frontend_img/r4.jpg" alt=""></a>	
												</div>
												<div class="recent-right">
													<h6 class="best2"><a href="single.html">Lorem ipsum dolor </a></h6>
													<div class="block">
											...
											<div class="recent-grids">
												<div class="recent-left">
													<a href="single.html"><img class="img-responsive " src="{{ asset('/') }}/images/frontend_img/r5.jpg" alt=""></a>	
												</div>
												<div class="recent-right">
													<h6 class="best2"><a href="single.html">Duis aute irure </a></h6>
													<div class="block">
									...
									<img class="img-responsive " src="{{ asset('/') }}/images/frontend_img/woo2.jpg" alt="">
								</div>
													...
													<div class="descr">
														<div class="reviews-top">
															<div class="reviews-left">
																<img src="{{ asset('/') }}/images/frontend_img/men3.jpg" alt=" " class="img-responsive">
															</div>
								...
								<div class="grid-arr">
									<div  class="grid-arrival">
										<figure>		
											<a href="single.html">
												<div class="grid-img">
													<img  src="{{ asset('/') }}/images/frontend_img/p28.jpg" class="img-responsive" alt="">
												</div>
												<div class="grid-img">
													<img  src="{{ asset('/') }}/images/frontend_img/p27.jpg" class="img-responsive"  alt="">
												</div>			
											</a>		
										</figure>	
									</div>
								...
								<div class="grid-arr">
									<div  class="grid-arrival">
										<figure>		
											<a href="single.html">
												<div class="grid-img">
													<img  src="{{ asset('/') }}/images/frontend_img/p30.jpg" class="img-responsive" alt="">
												</div>
												<div class="grid-img">
													<img  src="{{ asset('/') }}/images/frontend_img/p29.jpg" class="img-responsive"  alt="">
												</div>			
											</a>		
										</figure>	
									</div>
								...
								<div class="grid-arr">
									<div  class="grid-arrival">
										<figure>		
											<a href="single.html">
												<div class="grid-img">
													<img  src="{{ asset('/') }}/images/frontend_img/s2.jpg" class="img-responsive" alt="">
												</div>
												<div class="grid-img">
													<img  src="{{ asset('/') }}/images/frontend_img/s1.jpg" class="img-responsive"  alt="">
												</div>			
											</a>		
										</figure>	
									</div>
								...
								<div class="grid-arr">
									<div  class="grid-arrival">
										<figure>		
											<a href="single.html">
												<div class="grid-img">
													<img  src="{{ asset('/') }}/images/frontend_img/s4.jpg" class="img-responsive" alt="">
												</div>
												<div class="grid-img">
													<img  src="{{ asset('/') }}/images/frontend_img/s3.jpg" class="img-responsive"  alt="">
												</div>			
											</a>		
										</figure>	
									</div>
